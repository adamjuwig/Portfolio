            ...
            <div className="card-body">
              <div className="row">
                <div className="col-md-12">
                  <h3 className="fade">A little bit about me...</h3>
                  <hr />
                </div>
              </div>
              <div className="fade">
                <div>
                  ...
                  making things and colors appear on screens by writing in code. I
                  am a former professional musician and currently a restaurant
